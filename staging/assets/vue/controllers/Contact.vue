        ...
        <div class="w-full flex flex-col items-center justify-center gap-6">
            <FormKit type="form" id="contactForm" @submit="contact" :actions="false">
                <div class="w-full max-w-sm pt-6 px-3 flex flex-col gap-3">
                    <FormKit type="text" name="contactName " label="Nom du contact" placeholder="Dupont"
                    ...
                    <FormKit type="email" name="emailAddress" label="Addresse email" prefix-icon="email"
                        placeholder="dupont@gmail.com" validation="required|length:6,60|email" validation-visibility="live"
                        :validation-messages="{
                    ...
                    <FormKit type="number" name="siret" label="Numéro siret" placeholder="12345678901234"
                        validation="required|matches:/^[0-9]{14}$/" :validation-messages="{
                            required: 'Veuillez saisir votre numéro de siret',
                            matches: 'Votre numéro de siret doit comporter 14 chiffres',
                        }" validation-visibility="dirty" />
                    <FormKit type="text" name="vat" label="Numéro TVA" validation="required|length:12,20"
                    ...
                    <FormKit type="textarea" name="additionalNotes" label="Informations complémentaire"
                        validation="length:6,500" rows="10" validation-visibility="live" :validation-messages="{
