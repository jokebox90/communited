 ...
 */
final class Version20230215011054 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE shop_payments (unique_id VARCHAR(36) NOT NULL, customer_id VARCHAR(36) DEFAULT NULL, order_id VARCHAR(36) NOT NULL, amount DOUBLE PRECISION NOT NULL, user_agent CLOB NOT NULL, user_ip VARCHAR(60) NOT NULL, card_name VARCHAR(30) NOT NULL, card_number VARCHAR(30) NOT NULL, card_type VARCHAR(20) NOT NULL, additional_notes CLOB DEFAULT NULL, created_at DATETIME NOT NULL, status VARCHAR(20) NOT NULL, modified_at DATETIME NOT NULL, PRIMARY KEY(unique_id), CONSTRAINT FK_BE6A61A49395C3F3 FOREIGN KEY (customer_id) REFERENCES shop_customers (unique_id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BE6A61A48D9F6D38 FOREIGN KEY (order_id) REFERENCES shop_orders (unique_id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE shop_prices (unique_id VARCHAR(36) NOT NULL, item_id VARCHAR(36) DEFAULT NULL, contact_id VARCHAR(36) NOT NULL, status VARCHAR(20) NOT NULL, amount DOUBLE PRECISION NOT NULL, duration INTEGER NOT NULL, frequency VARCHAR(20) NOT NULL, description VARCHAR(120) NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, PRIMARY KEY(unique_id), CONSTRAINT FK_61694BDB126F525E FOREIGN KEY (item_id) REFERENCES shop_items (unique_id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_61694BDBE7A1254A FOREIGN KEY (contact_id) REFERENCES shop_contacts (unique_id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_61694BDB126F525E ON shop_prices (item_id)');
        $this->addSql('CREATE INDEX IDX_61694BDBE7A1254A ON shop_prices (contact_id)');
        $this->addSql('CREATE INDEX price_idx ON shop_prices (item_id, status)');
        $this->addSql('CREATE TABLE shop_sold (unique_id VARCHAR(36) NOT NULL, order_id VARCHAR(36) NOT NULL, price_id VARCHAR(36) NOT NULL, additional_notes CLOB DEFAULT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, PRIMARY KEY(unique_id), CONSTRAINT FK_59203BE28D9F6D38 FOREIGN KEY (order_id) REFERENCES shop_orders (unique_id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_59203BE2D614C7E7 FOREIGN KEY (price_id) REFERENCES shop_prices (unique_id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
