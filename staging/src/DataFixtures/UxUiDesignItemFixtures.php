...
class UxUiDesignItemFixtures extends Fixture implements FixtureGroupInterface, DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $array = [
            "uniqueId"    => $uniqueId,
            "title"       => "Ux/Ui Design",
            "description" => "Formation en Ux/Ui Design",
            "available"   => 60,
            "tags"        => ["formation", "ux", "ui", "design"],
            "status"      => "actif",
            "prices"      => [
                [
                    "uniqueId"    => $this->uuid->create(),
