  ...
  config: {
    classes: generateClasses({
      ...
      global: {
        ...
        input:
          "appearance-none bg-zinc-100 text-black focus:outline-none focus:ring-0 focus:shadow-none",
        ...
        prefixIcon:
          "w-12 flex self-stretch grow-0 shrink-0 rounded-tl-lg rounded-bl-lg border-r-8 border-yellow-500 bg-zinc-500 text-white from-transparent to-gray-200 [&>svg]:w-full [&>svg]:max-w-[1em] [&>svg]:max-h-[1em] [&>svg]:m-auto",
        suffixIcon:
          "w-12 flex self-stretch grow-0 shrink-0 rounded-tr-lg rounded-br-lg border-l-8 border-rose-700 bg-zinc-500 text-white from-gray-200 to-transparent [&>svg]:w-full [&>svg]:max-w-[1em] [&>svg]:max-h-[1em] [&>svg]:m-auto",
      },
