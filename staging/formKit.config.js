  ...
  config: {
    classes: generateClasses({
      ...
      global: {
        ...
        input:
          "appearance-none bg-slate-100 text-black focus:outline-none focus:ring-0 focus:shadow-none",
        ...
        prefixIcon:
          "w-12 flex self-stretch grow-0 shrink-0 rounded-tl-lg rounded-bl-lg border-r-8 border-yellow-500 bg-slate-500 text-white from-transparent to-gray-200 [&>svg]:w-full [&>svg]:max-w-[1em] [&>svg]:max-h-[1em] [&>svg]:m-auto",
        suffixIcon:
          "w-12 flex self-stretch grow-0 shrink-0 rounded-tr-lg rounded-br-lg border-l-8 border-rose-700 bg-slate-500 text-white from-gray-200 to-transparent [&>svg]:w-full [&>svg]:max-w-[1em] [&>svg]:max-h-[1em] [&>svg]:m-auto",
      },
      ...
      "family:button": {
        input:
          "$reset inline-flex py-4 px-8 items-center justify-start gap-3 bg-blue-600 text-white md:text-sm font-normal rounded-xl focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin",
        wrapper: "mb-1",
        prefixIcon: "$reset block w-auto h-full stretch",
        suffixIcon: "$reset block w-4 stretch",
      },
      "family:dropdown": {
        dropdownWrapper:
      ...
      "family:text": {
        inner:
          "flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded-lg mb-1",
        input:
      ...
      submit: {
        wrapper: "$reset flex flex-row",
        input:
          "$reset transition ease-in-out delay-150 duration-500 inline-flex items-center bg-green-500 hover:bg-green-400 text-white text-sm font-normal py-3 px-8 rounded-lg focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin",
        prefixIcon: "w-5 mr-1",
        suffixIcon: "w-5 ml-1",
      },
      color: {
