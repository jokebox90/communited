...
export default {
  ...
  config: {
    classes: generateClasses({
      ...
      'family:text': {
        inner: 'flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded-lg mb-1',
      ...
      submit: {
        ...
        input: '$reset transition ease-in-out delay-150 duration-500 inline-flex items-center bg-green-500 hover:bg-green-400 text-white text-sm font-normal py-3 px-8 rounded-lg focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin',
        prefixIcon: "w-5 mr-1",
        suffixIcon: "w-5 ml-1",
      },
      color: {
